...
class EmailHandler implements Runnable {
    ...
    static boolean sendEmail(String from, String toEmailList_csv, String ccEmailList_csv, String subject, String message) {
    ...
    def void run() {
        try {
            ...
            message.setHeader("X-Mailer", "Mortality Trigger Tool")

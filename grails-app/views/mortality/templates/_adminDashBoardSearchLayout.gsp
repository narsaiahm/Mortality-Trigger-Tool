    ...
    <g:form controller="mortality" name="adminSearchForm" action="displaySearchResults">
        <div class="form-group margin">
            ...
            <label id="unAssigned&incomplete" class="radio-inline">
                <input type="radio" id = "formStatus_unassigned" name="formStatus" value="UNASSIGNED">Unassigned & Incomplete
            </label>
            <label class="radio-inline">
                <input name="formStatus" id = "formStatus_complete" type="radio" value="SUBMITTED">Complete
            </label>
        </div>
        ...
        <g:link controller=" Mortality" action="adminDashboard">
            ...
            <g:actionSubmit value="Export Data" action ="exportData" class="btn btn-primary" onclick="this.form.action='${createLink(action:'exportData')}';"></g:actionSubmit>
        </div>

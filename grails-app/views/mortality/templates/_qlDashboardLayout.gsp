...
<div id="refresh" class="col-md-12">
    <div class="tableArea">
        <div class="row">
            <span class="textTitle fleft">Assigned: Unaccepted</span>
                                ...
                                <tr class="tableRow">
                                    <td>
                                        ...
                                        <g:link action="assignReviewForm"
                                                params="[reviewId: reviewInfo.id, status: reviewInfo.status, patientName: reviewInfo.patientName, mrn: reviewInfo.mrn]">
                                            <button type="button"
                                    ...
                                    <td><span>${reviewInfo.dischargingDepartment}</span></td>
        ...
        <div class="row">
            <span class="textTitle">Assigned: Incomplete</span>
            <div class="col-md-12 margin_top_-10">
                <div class="table-responsive">
            ...
            <div class="col-md-12 margin_top_-10">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover tableQlead">
                        ...
                        <tbody>
                        <g:each in="${reviewList}" var="reviewInfo">
                            <g:if test="${reviewInfo.status?.equals(MortalityConstants.SUBMITTED)}">
                                <tr class="tableRow">
                                    <td><g:link action="review"
                                                params="[reviewId: reviewInfo.id]">
                                        <span>${reviewInfo.patientName}</span></g:link></td>
                        ...
                        <g:if test="${reviewList.grep{it -> it.status?.equals(MortalityConstants.SUBMITTED)}.size()==0}">
                            <tr><td colspan="9">No records found</td></tr>
                        </g:if>
                        </tbody>
                    </table>
